...
module TypeScript {
    ...
    export class DeclarationEmitter {
        ...
        private getEnclosingContainer(ast: ISyntaxElement): ISyntaxElement {
            ast = ast.parent;
            while (ast) {
        ...
        private emitDeclarationsForModuleDeclaration(moduleDecl: ModuleDeclarationSyntax) {
            ...
            var name: ISyntaxElement = moduleDecl.stringLiteral || ArrayUtilities.first(getModuleNames(moduleDecl.name));
